...
class RegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        registerButton.addTarget(self,
                              action: #selector(registerButtonTapper),
                              for: .touchUpInside)
    ...
    @objc private func registerButtonTapper() {
        ...
        guard let firstName = firstNameField.text,
            ...
            alertUserLoginErrort()
            return
        }
        // Firebase login
    }
    func alertUserLoginErrort() {
...
extension RegisterViewController: UILargeContentViewerInteractionDelegate, UINavigationControllerDelegate {
